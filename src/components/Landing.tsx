...
export type LandingTarget = 'map' | 'tree' | 'present' | 'books' | 'media' | 'feasts' | 'shelf' | 'support';
    ...
    <div className="h-full overflow-y-auto bg-paper-2">
      ...
      <div className="flex flex-col gap-5 bg-deepest px-5 py-8 sm:px-10 lg:flex-row lg:items-center lg:gap-8 lg:px-14">
        ...
        <div className="flex flex-wrap items-center gap-5">
          ...
          <a href="#impressum" className="text-[12.5px] font-medium text-white/60 transition hover:text-white">
            {t('imprint')}
          </a>
          <a
