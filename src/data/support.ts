...
export const SUPPORT_PROJECTS: SupportProject[] = [
  ...
  },
  {
    ...
    kind: 'data',
    role: {
      de: 'Die Reiche und Grenzen hinter dem Zeitregler – zwölf Kartenblätter von 2000 v. Chr. bis 100 n. Chr.',
      en: 'The empires and borders behind the year slider – twelve map sheets from 2000 BC to AD 100.',
    },
    credit: {
      de: 'Kartengrundlage: aourednik/historical-basemaps, GPL-3.0. Grenzverläufe sind Annäherungen.',
      en: 'Base data: aourednik/historical-basemaps, GPL-3.0. The borders are approximations.',
    },
    home: 'https://github.com/aourednik/historical-basemaps',
    donate: null,
    donateNote: {
      de: 'Ein Open-Source-Datensatz ohne Spendenseite – ein Stern oder eine Korrektur am Datensatz sind die Währung.',
      en: 'An open-source dataset with no giving page – a star or a correction to the data is the currency.',
    },
  },
  {
    id: 'wikimedia',
