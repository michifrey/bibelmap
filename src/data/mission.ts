...
export const JOURNEYS: MissionJourney[] = [
  {
    ...
    stops: [
      { de: 'Jerusalem', en: 'Jerusalem', lat: 31.777, lon: 35.234, placeId: 'a15257a', ref: { de: 'Apg 2,1-41', en: 'Acts 2:1-41' }, note: { de: 'Pfingsten: Menschen aus fünfzehn Ländern hören die Botschaft in ihrer eigenen Sprache.', en: 'Pentecost: people from fifteen lands hear the message each in their own language.' } },
      { de: 'Samarien', en: 'Samaria', lat: 32.276, lon: 35.195, placeId: 'a041bb3', ref: { de: 'Apg 8,4-8', en: 'Acts 8:4-8' }, note: { de: 'Die Verfolgung nach Stephanus treibt die Gemeinde aus der Stadt – Philippus predigt in Samarien.', en: 'The persecution after Stephen drives the church out of the city – Philip preaches in Samaria.' } },
      { de: 'Straße nach Gaza', en: 'Road to Gaza', lat: 31.504, lon: 34.464, placeId: 'aa8edd2', ref: { de: 'Apg 8,26-39', en: 'Acts 8:26-39' }, note: { de: 'Der äthiopische Hofbeamte kehrt getauft nach Afrika zurück.', en: 'The Ethiopian court official returns to Africa baptised.' } },
      { de: 'Damaskus', en: 'Damascus', lat: 33.511, lon: 36.306, placeId: 'a69c1d4', ref: { de: 'Apg 9,1-19', en: 'Acts 9:1-19' }, note: { de: 'Der Verfolger Saulus wird zum Zeugen.', en: 'Saul the persecutor becomes a witness.' } },
      { de: 'Joppe', en: 'Joppa', lat: 32.054, lon: 34.753, placeId: 'ae023a9', ref: { de: 'Apg 9,36-43', en: 'Acts 9:36-43' } },
      { de: 'Cäsarea', en: 'Caesarea', lat: 32.5, lon: 34.892, placeId: 'a58735e', ref: { de: 'Apg 10,1-48', en: 'Acts 10:1-48' }, note: { de: 'Kornelius: der erste Nichtjude, der ohne Umweg dazugehört.', en: 'Cornelius: the first Gentile to belong without detour.' } },
      { de: 'Zypern & Kyrene', en: 'Cyprus & Cyrene', lat: 32.82, lon: 21.85, placeId: 'a81cdb5', ref: { de: 'Apg 11,19-20', en: 'Acts 11:19-20' }, note: { de: 'Namenlose Flüchtlinge aus Zypern und Kyrene sprechen als Erste auch zu Griechen.', en: 'Nameless refugees from Cyprus and Cyrene are the first to speak to Greeks as well.' } },
      { de: 'Antiochia am Orontes', en: 'Antioch on the Orontes', lat: 36.227, lon: 36.172, placeId: 'ae41ab4', ref: { de: 'Apg 11,19-26', en: 'Acts 11:19-26' }, note: { de: 'Hier heißen die Jünger zum ersten Mal „Christen“ – und von hier aus geht die Mission weiter.', en: 'Here the disciples are first called "Christians" – and from here the mission goes on.' } },
    ],
  },
  {
    id: 'first',
    ...
    stops: [
      { de: 'Antiochia am Orontes', en: 'Antioch on the Orontes', lat: 36.227, lon: 36.172, placeId: 'ae41ab4', ref: { de: 'Apg 13,1-3', en: 'Acts 13:1-3' }, note: { de: 'Die Gemeinde fastet, betet und lässt die beiden ziehen.', en: 'The church fasts, prays and lets the two go.' } },
      { de: 'Seleukia', en: 'Seleucia', lat: 36.124, lon: 35.922, placeId: 'a6d306d', ref: { de: 'Apg 13,4', en: 'Acts 13:4' } },
      { de: 'Salamis (Zypern)', en: 'Salamis (Cyprus)', lat: 35.185, lon: 33.902, placeId: 'afa863b', ref: { de: 'Apg 13,5', en: 'Acts 13:5' } },
      { de: 'Paphos', en: 'Paphos', lat: 34.756, lon: 32.404, placeId: 'a314765', ref: { de: 'Apg 13,6-12', en: 'Acts 13:6-12' }, note: { de: 'Der Statthalter Sergius Paulus kommt zum Glauben; ab hier heißt Saulus Paulus.', en: 'The proconsul Sergius Paulus believes; from here Saul is called Paul.' } },
      { de: 'Perge', en: 'Perga', lat: 36.96, lon: 30.854, placeId: 'aff04b8', ref: { de: 'Apg 13,13', en: 'Acts 13:13' }, note: { de: 'Johannes Markus kehrt um – später der Grund für den Streit mit Barnabas.', en: 'John Mark turns back – later the reason for the split with Barnabas.' } },
      { de: 'Antiochia in Pisidien', en: 'Antioch in Pisidia', lat: 38.306, lon: 31.189, placeId: 'a6c704a', ref: { de: 'Apg 13,14-52', en: 'Acts 13:14-52' }, note: { de: '„So wenden wir uns zu den Heiden“ – die Predigt in der Synagoge wird zum Wendepunkt.', en: '"We turn to the Gentiles" – the synagogue sermon becomes the turning point.' } },
      { de: 'Ikonion', en: 'Iconium', lat: 37.872, lon: 32.492, placeId: 'ae425aa', ref: { de: 'Apg 14,1-5', en: 'Acts 14:1-5' } },
      { de: 'Lystra', en: 'Lystra', lat: 37.602, lon: 32.338, placeId: 'af0719d', ref: { de: 'Apg 14,6-19', en: 'Acts 14:6-19' }, note: { de: 'Erst hält man die beiden für Götter, dann wird Paulus gesteinigt und für tot gehalten.', en: 'First taken for gods, then Paul is stoned and left for dead.' } },
      { de: 'Derbe', en: 'Derbe', lat: 37.349, lon: 33.361, placeId: 'aa401a9', ref: { de: 'Apg 14,20-21', en: 'Acts 14:20-21' } },
      { de: 'Lystra, Ikonion, Antiochia', en: 'Lystra, Iconium, Antioch', lat: 37.602, lon: 32.338, placeId: 'af0719d', ref: { de: 'Apg 14,21-23', en: 'Acts 14:21-23' }, note: { de: 'Rückweg durch dieselben Städte: Älteste werden eingesetzt.', en: 'Back through the same towns: elders are appointed.' }, back: true },
      { de: 'Perge', en: 'Perga', lat: 36.96, lon: 30.854, placeId: 'aff04b8', ref: { de: 'Apg 14,25', en: 'Acts 14:25' }, back: true },
      { de: 'Attalia', en: 'Attalia', lat: 36.881, lon: 30.704, placeId: 'ac744c1', ref: { de: 'Apg 14,25', en: 'Acts 14:25' }, back: true },
      { de: 'Antiochia am Orontes', en: 'Antioch on the Orontes', lat: 36.227, lon: 36.172, placeId: 'ae41ab4', ref: { de: 'Apg 14,26-28', en: 'Acts 14:26-28' }, note: { de: 'Bericht an die sendende Gemeinde: Gott hat den Heiden „die Tür des Glaubens aufgetan“.', en: 'Report to the sending church: God has opened "a door of faith" to the Gentiles.' }, back: true },
    ],
  },
  {
    id: 'second',
    ...
    stops: [
      { de: 'Antiochia am Orontes', en: 'Antioch on the Orontes', lat: 36.227, lon: 36.172, placeId: 'ae41ab4', ref: { de: 'Apg 15,36-40', en: 'Acts 15:36-40' } },
      { de: 'Syrien & Zilizien (Tarsus)', en: 'Syria & Cilicia (Tarsus)', lat: 36.913, lon: 34.892, placeId: 'a666ea0', ref: { de: 'Apg 15,41', en: 'Acts 15:41' } },
      { de: 'Derbe', en: 'Derbe', lat: 37.349, lon: 33.361, placeId: 'aa401a9', ref: { de: 'Apg 16,1', en: 'Acts 16:1' } },
      { de: 'Lystra', en: 'Lystra', lat: 37.602, lon: 32.338, placeId: 'af0719d', ref: { de: 'Apg 16,1-3', en: 'Acts 16:1-3' }, note: { de: 'Timotheus schließt sich an.', en: 'Timothy joins the team.' } },
      { de: 'Phrygien & Galatien', en: 'Phrygia & Galatia', lat: 39.27, lon: 32.98, placeId: 'a0f440a', ref: { de: 'Apg 16,6', en: 'Acts 16:6' } },
      { de: 'Troas', en: 'Troas', lat: 39.752, lon: 26.159, placeId: 'a91c509', ref: { de: 'Apg 16,8-10', en: 'Acts 16:8-10' }, note: { de: '„Komm herüber nach Mazedonien und hilf uns.“', en: '"Come over to Macedonia and help us."' } },
      ...
      { de: 'Philippi', en: 'Philippi', lat: 41.012, lon: 24.285, placeId: 'a49e1d0', ref: { de: 'Apg 16,12-40', en: 'Acts 16:12-40' }, note: { de: 'Lydia, die Purpurhändlerin, und der Kerkermeister – die erste Gemeinde Europas.', en: 'Lydia the purple-seller and the jailer – the first church in Europe.' } },
      { de: 'Amphipolis & Apollonia', en: 'Amphipolis & Apollonia', lat: 40.82, lon: 23.847, placeId: 'a4bdea7', ref: { de: 'Apg 17,1', en: 'Acts 17:1' } },
      { de: 'Thessalonich', en: 'Thessalonica', lat: 40.638, lon: 22.946, placeId: 'afa9d8e', ref: { de: 'Apg 17,1-9', en: 'Acts 17:1-9' } },
      { de: 'Beröa', en: 'Berea', lat: 40.518, lon: 22.2, placeId: 'a62fe31', ref: { de: 'Apg 17,10-14', en: 'Acts 17:10-14' }, note: { de: 'Sie prüfen täglich in der Schrift, ob es sich so verhält.', en: 'They examine the Scriptures daily to see whether it is so.' } },
      { de: 'Athen', en: 'Athens', lat: 37.972, lon: 23.727, placeId: 'a1fe6e7', ref: { de: 'Apg 17,15-34', en: 'Acts 17:15-34' }, note: { de: 'Die Rede auf dem Areopag: „dem unbekannten Gott“.', en: 'The Areopagus speech: "to the unknown god".' } },
      { de: 'Korinth', en: 'Corinth', lat: 37.906, lon: 22.879, placeId: 'a6f437a', ref: { de: 'Apg 18,1-17', en: 'Acts 18:1-17' }, note: { de: 'Anderthalb Jahre bei Priska und Aquila; hier entstehen die Thessalonicherbriefe.', en: 'Eighteen months with Priscilla and Aquila; the Thessalonian letters are written here.' } },
      { de: 'Kenchreä', en: 'Cenchreae', lat: 37.884, lon: 22.997, placeId: 'aa31dd3', ref: { de: 'Apg 18,18', en: 'Acts 18:18' }, back: true },
      { de: 'Ephesus', en: 'Ephesus', lat: 37.939, lon: 27.341, placeId: 'a5feb15', ref: { de: 'Apg 18,19-21', en: 'Acts 18:19-21' }, back: true },
      { de: 'Cäsarea', en: 'Caesarea', lat: 32.5, lon: 34.892, placeId: 'a58735e', ref: { de: 'Apg 18,22', en: 'Acts 18:22' }, back: true },
      { de: 'Jerusalem & Antiochia', en: 'Jerusalem & Antioch', lat: 31.777, lon: 35.234, placeId: 'a15257a', ref: { de: 'Apg 18,22', en: 'Acts 18:22' }, back: true },
    ],
  },
  {
    id: 'third',
    ...
    stops: [
      { de: 'Antiochia am Orontes', en: 'Antioch on the Orontes', lat: 36.227, lon: 36.172, placeId: 'ae41ab4', ref: { de: 'Apg 18,23', en: 'Acts 18:23' } },
      { de: 'Galatien & Phrygien', en: 'Galatia & Phrygia', lat: 39.27, lon: 32.98, placeId: 'a0f440a', ref: { de: 'Apg 18,23', en: 'Acts 18:23' } },
      { de: 'Ephesus', en: 'Ephesus', lat: 37.939, lon: 27.341, placeId: 'a5feb15', ref: { de: 'Apg 19,1-41', en: 'Acts 19:1-41' }, note: { de: 'Zwei Jahre täglich im Hörsaal des Tyrannus; der Aufruhr der Silberschmiede.', en: 'Two years daily in the hall of Tyrannus; the silversmiths’ riot.' } },
      { de: 'Mazedonien', en: 'Macedonia', lat: 41.6, lon: 22.54, placeId: 'a69e1b8', ref: { de: 'Apg 20,1-2', en: 'Acts 20:1-2' } },
      { de: 'Griechenland (Korinth)', en: 'Greece (Corinth)', lat: 37.906, lon: 22.879, placeId: 'a6f437a', ref: { de: 'Apg 20,2-3', en: 'Acts 20:2-3' }, note: { de: 'Drei Monate; hier entsteht der Römerbrief.', en: 'Three months; the letter to the Romans is written here.' } },
      { de: 'Philippi', en: 'Philippi', lat: 41.012, lon: 24.285, placeId: 'a49e1d0', ref: { de: 'Apg 20,6', en: 'Acts 20:6' }, back: true },
      { de: 'Troas', en: 'Troas', lat: 39.752, lon: 26.159, placeId: 'a91c509', ref: { de: 'Apg 20,6-12', en: 'Acts 20:6-12' }, note: { de: 'Eutychus fällt aus dem Fenster – und steht wieder auf.', en: 'Eutychus falls from the window – and gets up again.' }, back: true },
      { de: 'Assos & Mitylene', en: 'Assos & Mitylene', lat: 39.491, lon: 26.337, placeId: 'a0a2ca7', ref: { de: 'Apg 20,13-14', en: 'Acts 20:13-14' }, back: true },
      { de: 'Chios & Samos', en: 'Chios & Samos', lat: 38.373, lon: 26.137, placeId: 'a4c2c75', ref: { de: 'Apg 20,15', en: 'Acts 20:15' }, back: true },
      { de: 'Milet', en: 'Miletus', lat: 37.531, lon: 27.276, placeId: 'a55027d', ref: { de: 'Apg 20,15-38', en: 'Acts 20:15-38' }, note: { de: 'Der Abschied von den Ältesten aus Ephesus.', en: 'The farewell to the elders from Ephesus.' }, back: true },
      { de: 'Kos, Rhodos, Patara', en: 'Cos, Rhodes, Patara', lat: 36.82, lon: 27.11, placeId: 'a398e5d', ref: { de: 'Apg 21,1', en: 'Acts 21:1' }, back: true },
      { de: 'Tyrus', en: 'Tyre', lat: 33.271, lon: 35.196, placeId: 'a160272', ref: { de: 'Apg 21,3-6', en: 'Acts 21:3-6' }, back: true },
      { de: 'Ptolemais', en: 'Ptolemais', lat: 32.921, lon: 35.069, placeId: 'abc2af0', ref: { de: 'Apg 21,7', en: 'Acts 21:7' }, back: true },
      { de: 'Cäsarea', en: 'Caesarea', lat: 32.5, lon: 34.892, placeId: 'a58735e', ref: { de: 'Apg 21,8-14', en: 'Acts 21:8-14' }, note: { de: 'Agabus kündigt die Gefangenschaft an; Paulus reist weiter.', en: 'Agabus foretells the imprisonment; Paul travels on.' }, back: true },
      { de: 'Jerusalem', en: 'Jerusalem', lat: 31.777, lon: 35.234, placeId: 'a15257a', ref: { de: 'Apg 21,15-17', en: 'Acts 21:15-17' }, back: true },
    ],
  },
  {
    id: 'rome',
    ...
    stops: [
      { de: 'Cäsarea', en: 'Caesarea', lat: 32.5, lon: 34.892, placeId: 'a58735e', ref: { de: 'Apg 27,1-2', en: 'Acts 27:1-2' } },
      { de: 'Sidon', en: 'Sidon', lat: 33.561, lon: 35.372, placeId: 'a98e4d7', ref: { de: 'Apg 27,3', en: 'Acts 27:3' } },
      { de: 'Myra', en: 'Myra', lat: 36.259, lon: 29.985, placeId: 'aa4b3e2', ref: { de: 'Apg 27,5-6', en: 'Acts 27:5-6' }, note: { de: 'Umstieg auf ein alexandrinisches Getreideschiff.', en: 'Transfer to an Alexandrian grain ship.' } },
      { de: 'Knidos', en: 'Cnidus', lat: 36.686, lon: 27.375, placeId: 'ab793ce', ref: { de: 'Apg 27,7', en: 'Acts 27:7' } },
      { de: 'Schöne Häfen (Kreta)', en: 'Fair Havens (Crete)', lat: 34.93, lon: 24.8, placeId: 'aae626a', ref: { de: 'Apg 27,8-12', en: 'Acts 27:8-12' }, note: { de: 'Paulus rät zu überwintern – man fährt trotzdem weiter.', en: 'Paul advises wintering there – they sail on anyway.' } },
      { de: 'Kauda', en: 'Cauda', lat: 34.833, lon: 24.083, placeId: 'aca2b0a', ref: { de: 'Apg 27,16', en: 'Acts 27:16' }, note: { de: 'Vierzehn Tage im Sturm „Eurakylon“.', en: 'Fourteen days in the storm called "Euraquilo".' } },
      { de: 'Malta', en: 'Malta', lat: 35.933, lon: 14.412, placeId: 'a57835d', ref: { de: 'Apg 27,39-28,10', en: 'Acts 27:39-28:10' }, note: { de: 'Schiffbruch, Schlangenbiss, Heilungen – und ein Winter auf der Insel.', en: 'Shipwreck, snakebite, healings – and a winter on the island.' } },
      { de: 'Syrakus', en: 'Syracuse', lat: 37.064, lon: 15.293, placeId: 'a1e3697', ref: { de: 'Apg 28,12', en: 'Acts 28:12' } },
      { de: 'Rhegion', en: 'Rhegium', lat: 38.109, lon: 15.644, placeId: 'a63bb26', ref: { de: 'Apg 28,13', en: 'Acts 28:13' } },
      { de: 'Puteoli', en: 'Puteoli', lat: 40.826, lon: 14.121, placeId: 'a4488e9', ref: { de: 'Apg 28,13-14', en: 'Acts 28:13-14' }, note: { de: 'Dort finden sie bereits Brüder – die Gemeinde war schneller.', en: 'They already find brothers there – the church got there first.' } },
      { de: 'Drei Tavernen', en: 'Three Taverns', lat: 41.562, lon: 12.874, placeId: 'afef438', ref: { de: 'Apg 28,15', en: 'Acts 28:15' } },
      { de: 'Rom', en: 'Rome', lat: 41.892, lon: 12.485, placeId: 'afc8e7a', ref: { de: 'Apg 28,16-31', en: 'Acts 28:16-31' }, note: { de: 'Zwei Jahre in einer Mietwohnung: „Er predigte das Reich Gottes … ungehindert.“', en: 'Two years in rented lodgings: "proclaiming the kingdom of God … unhindered."' } },
    ],
  },
];
