...
export interface Father {
  ...
  en: string;
  city: string;
  /** Ortsname auf Englisch, wo er abweicht; sonst gilt `city`. */
  cityEn?: string;
  lat: number;
  lon: number;
  years: string;
...
export interface Council {
  id: string;
  name: string;
  /** Name auf Englisch, wo er abweicht; sonst gilt `name`. */
  nameEn?: string;
  city: string;
  /** Ortsname auf Englisch, wo er abweicht; sonst gilt `city`. */
  cityEn?: string;
...
/**
 * Ortsname und Konzilname in der gewählten Sprache.
 *
 * Beide standen als **ein** Feld in den Daten und wurden unverändert in beide
 * Oberflächen gerendert: auf Englisch also „Mailand", „Karthago", „Antiochia",
 * „Vatikanum I", „Laterankonzil IV". Die i18n-Prüfung fand davon nur einen
 * einzigen Fall – ihre Wortliste kennt Funktionswörter, keine Eigennamen.
 *
 * Ein fehlendes `…En` ist kein Mangel, sondern die Regel: Alexandria, Smyrna,
 * Ephesus, Hippo und Chalcedon heißen in beiden Sprachen gleich.
 */
export const cityName = (x: { city: string; cityEn?: string }, lang: 'de' | 'en'): string =>
  lang === 'en' ? (x.cityEn ?? x.city) : x.city;

export const councilName = (c: Council, lang: 'de' | 'en'): string =>
...
export const COUNCILS: Council[] = [
  { id: 'jerusalem', name: 'Apostelkonzil', nameEn: 'Council of Jerusalem', city: 'Jerusalem', lat: 31.78, lon: 35.23, year: '~49',
  ...
  { id: 'nicaea1', name: 'Nicäa I', nameEn: 'Nicaea I', city: 'Nicäa (İznik)', cityEn: 'Nicaea (İznik)', lat: 40.43, lon: 29.72, year: '325',
    recognisedBy: ['west', 'east', 'orient'],
  ...
  { id: 'constantinople1', name: 'Konstantinopel I', nameEn: 'Constantinople I', city: 'Konstantinopel', cityEn: 'Constantinople', lat: 41.01, lon: 28.98, year: '381',
    recognisedBy: ['west', 'east', 'orient'],
  ...
  { id: 'constantinople2', name: 'Konstantinopel II', nameEn: 'Constantinople II', city: 'Konstantinopel', cityEn: 'Constantinople', lat: 41.01, lon: 28.98, year: '553',
    recognisedBy: ['west', 'east'],
  ...
  { id: 'constantinople3', name: 'Konstantinopel III', nameEn: 'Constantinople III', city: 'Konstantinopel', cityEn: 'Constantinople', lat: 41.01, lon: 28.98, year: '680–681',
    recognisedBy: ['west', 'east'],
  ...
  { id: 'nicaea2', name: 'Nicäa II', nameEn: 'Nicaea II', city: 'Nicäa (İznik)', cityEn: 'Nicaea (İznik)', lat: 40.43, lon: 29.72, year: '787',
    recognisedBy: ['west', 'east'],
  ...
  { id: 'lateran4', name: 'Laterankonzil IV', nameEn: 'Lateran IV', city: 'Rom', cityEn: 'Rome', lat: 41.89, lon: 12.51, year: '1215',
    recognisedBy: ['west'],
  ...
  { id: 'konstanz', name: 'Konstanz', nameEn: 'Constance', city: 'Konstanz', cityEn: 'Constance', lat: 47.66, lon: 9.18, year: '1414–1418',
    recognisedBy: ['west'],
  ...
  { id: 'ferrara', name: 'Ferrara–Florenz', nameEn: 'Ferrara–Florence', city: 'Florenz', cityEn: 'Florence', lat: 43.77, lon: 11.26, year: '1438–1445',
    recognisedBy: ['west'],
  ...
  { id: 'trient', name: 'Trient', nameEn: 'Trent', city: 'Trient (Trento)', cityEn: 'Trent (Trento)', lat: 46.07, lon: 11.12, year: '1545–1563',
    recognisedBy: ['west'],
  ...
  { id: 'vatikan1', name: 'Vatikanum I', nameEn: 'Vatican I', city: 'Rom', cityEn: 'Rome', lat: 41.9, lon: 12.45, year: '1869–1870',
    recognisedBy: ['west'],
  ...
  { id: 'vatikan2', name: 'Vatikanum II', nameEn: 'Vatican II', city: 'Rom', cityEn: 'Rome', lat: 41.9, lon: 12.45, year: '1962–1965',
    recognisedBy: ['west'],
