...
export interface Person {
  ...
  city?: string;
  /**
   * Der Ortsname auf Englisch, wo er abweicht. `city` allein stand in beiden
   * Oberflächen – auf Englisch also „Mailand", „Karthago", „Antiochia". Die
   * i18n-Prüfung sah das nicht: Ihre Wortliste kennt Funktionswörter, keine
   * Ortsnamen. Fehlt das Feld, bleibt es beim deutschen Namen – richtig für
   * Alexandria, Smyrna, Hippo.
   */
  cityEn?: string;
  tradition?: Tradition;
...
export const GENEALOGY: Person[] = [
  ...
  { id: 'jotam', de: 'Jotam', en: 'Jotham', parent: 'usija', line: true, born: -775, epoch: 'koenige', reignDe: 'regierte ≈ 750–735 v. Chr.', reignEn: 'reigned ≈ 750–735 BC', refs: ['2Kön 15:32-38', '2Chr 27'],
  ...
  { id: 'ahas', de: 'Ahas', en: 'Ahaz', parent: 'jotam', line: true, born: -755, epoch: 'koenige', reignDe: 'regierte ≈ 735–715 v. Chr.', reignEn: 'reigned ≈ 735–715 BC', refs: ['2Kön 16', '2Chr 28', 'Jes 7'],
    deText: 'Götzendiener; ihm gilt Jesajas Zeichen vom „Immanuel".', enText: "An idolater; to him Isaiah gave the sign of 'Immanuel'." },
  { id: 'hiskia', de: 'Hiskia', en: 'Hezekiah', parent: 'ahas', line: true, born: -740, epoch: 'koenige', reignDe: 'regierte ≈ 715–686 v. Chr.', reignEn: 'reigned ≈ 715–686 BC', refs: ['2Kön 18-20', '2Chr 29-32', 'Jes 36-39'],
  ...
  { id: 'polykarp', de: 'Polykarp von Smyrna', en: 'Polycarp of Smyrna', parent: 'paulus', line: true, faith: true, born: 69, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Bindeglied zwischen den Aposteln und der nächsten Generation: Irenäus hörte ihn noch von Johannes erzählen. Mit sechsundachtzig verbrannt, weil er nicht schwören wollte – der Bericht seiner Gemeinde darüber ist der älteste erhaltene Märtyrerbericht.', enText: 'The link between the apostles and the next generation: Irenaeus still heard him tell of John. Burned at eighty-six for refusing to swear – his congregation’s account of it is the oldest surviving martyrdom narrative.' },
  { id: 'justin', de: 'Justin der Märtyrer', en: 'Justin Martyr', parent: 'polykarp', line: true, faith: true, born: 100, epoch: 'kirchenvater', refs: [],
    city: 'Rom', cityEn: 'Rome', lat: 41.89, lon: 12.49, tradition: 'east', years: '≈ 100–165',
    deText: 'Trug den Philosophenmantel weiter, nachdem er Christ geworden war, und eröffnete in Rom eine Schule. Als erster erklärte er den Glauben in der Sprache derer, die ihn ablehnten – und beschrieb nebenbei einen Gottesdienst um 155 so genau, dass wir ihn heute noch nachvollziehen können.', enText: 'Went on wearing the philosopher’s cloak after becoming a Christian, and opened a school in Rome. He was the first to explain the faith in the language of those who rejected it – and described a service around 155 so precisely that we can still follow it today.' },
  { id: 'irenaeus', de: 'Irenäus von Lyon', en: 'Irenaeus of Lyon', parent: 'justin', line: true, faith: true, born: 130, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Gegen die Gnosis, die eine geheime Lehre für Eingeweihte versprach, setzt er das Öffentliche: eine Schrift, die vom Schöpfer bis zur Erlösung eine Geschichte erzählt. Von ihm stammt die Idee, dass Christus den Weg Adams noch einmal geht und richtig zu Ende bringt.', enText: 'Against Gnosticism, which promised a secret teaching for initiates, he sets what is public: one Scripture telling one story from creator to redemption. From him comes the idea that Christ walks Adam’s road again and this time carries it through.' },
  { id: 'origenes', de: 'Origenes', en: 'Origen', parent: 'irenaeus', faith: true, born: 184, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Der erste, der die ganze Bibel systematisch auslegte, und der erste, der sechs Textfassungen nebeneinanderstellte, um den Wortlaut zu prüfen. Drei Jahrhunderte nach seinem Tod verurteilte man Sätze aus seinem Werk – gelesen wurde er trotzdem weiter.', enText: 'The first to expound the whole Bible systematically, and the first to set six versions of the text side by side to check the wording. Three centuries after his death propositions from his work were condemned – and he went on being read anyway.' },
  { id: 'athanasius', de: 'Athanasius', en: 'Athanasius', parent: 'irenaeus', line: true, faith: true, born: 296, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Fünfmal aus Alexandria verbannt, weil er nicht nachgab: Wenn Christus geschaffen wäre, hätte kein Geschöpf Gott begegnen können. Sein Osterbrief von 367 nennt zum ersten Mal genau die siebenundzwanzig Schriften, die heute das Neue Testament bilden.', enText: 'Exiled from Alexandria five times because he would not yield: if Christ were a creature, no creature could have met God. His Easter letter of 367 is the first to name exactly the twenty-seven writings that make up today’s New Testament.' },
  { id: 'hieronymus', de: 'Hieronymus', en: 'Jerome', parent: 'athanasius', faith: true, born: 347, epoch: 'kirchenvater', refs: [],
    city: 'Bethlehem', lat: 31.7, lon: 35.2, tradition: 'west', years: '≈ 347–420',
    deText: 'Zog nach Bethlehem und übersetzte die Bibel aus dem Hebräischen statt aus der griechischen Fassung – umstritten damals, maßgebend für tausend Jahre. Streitsüchtig bis zur Bosheit; einen großen Teil der Arbeit trug ein Kreis gelehrter Frauen um Paula mit.', enText: 'Moved to Bethlehem and translated the Bible from Hebrew rather than the Greek version – controversial then, authoritative for a thousand years. Quarrelsome to the point of malice; much of the work was carried with him by a circle of learned women around Paula.' },
  { id: 'augustinus', de: 'Augustinus von Hippo', en: 'Augustine of Hippo', parent: 'athanasius', line: true, faith: true, born: 354, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Beschrieb in den „Bekenntnissen" als erster ein Innenleben von innen – ein Buch, das es so vorher nicht gab. Nach der Plünderung Roms schrieb er den „Gottesstaat" gegen den Vorwurf, das Christentum habe das Reich ruiniert. Sein Erbe reicht bis zu Luther und Calvin.', enText: 'In the "Confessions" he described an inner life from the inside for the first time – a kind of book that did not exist before. After the sack of Rome he wrote "The City of God" against the charge that Christianity had ruined the empire. His legacy runs to Luther and Calvin.' },
  ...
  { id: 'clemens', de: 'Clemens von Rom', en: 'Clement of Rome', parent: 'petrus', faith: true, born: 35, epoch: 'urkirche', refs: [],
    city: 'Rom', cityEn: 'Rome', lat: 41.89, lon: 12.49, tradition: 'west', years: '≈ 35–99',
    deText: 'Schreibt um 96 aus Rom nach Korinth, weil dort eine Gemeinde ihre Ältesten abgesetzt hat – der älteste erhaltene christliche Text außerhalb des Neuen Testaments. Er argumentiert nicht mit Amtsgewalt, sondern mit dem Beispiel Christi.', enText: 'Writes from Rome to Corinth around 96, because a congregation there has deposed its elders – the oldest surviving Christian text outside the New Testament. He argues not from the authority of office but from the example of Christ.' },
  { id: 'ignatius', de: 'Ignatius von Antiochia', en: 'Ignatius of Antioch', parent: 'paulus', faith: true, born: 35, epoch: 'urkirche', refs: [],
    city: 'Antiochia', cityEn: 'Antioch', lat: 36.2, lon: 36.16, tradition: 'east', years: '≈ 35–108',
    deText: 'Auf dem Weg zur Hinrichtung nach Rom schreibt er sieben Briefe an die Gemeinden am Weg und bittet sie ausdrücklich, ihn nicht zu retten. In diesen Briefen steht zum ersten Mal das Wort „katholisch" für die Kirche als Ganze.', enText: 'On the road to his execution in Rome he writes seven letters to the churches along the way, expressly asking them not to save him. In these letters the word "catholic" first appears for the church as a whole.' },
  { id: 'tertullian', de: 'Tertullian', en: 'Tertullian', parent: 'irenaeus', faith: true, born: 155, epoch: 'kirchenvater', refs: [],
    city: 'Karthago', cityEn: 'Carthage', lat: 36.85, lon: 10.32, tradition: 'west', years: '≈ 155–220',
    deText: 'Prägte die lateinischen Wörter, mit denen die Kirche seither über Gott redet – „Trinitas", „persona", „substantia". Fragte spöttisch: „Was hat Athen mit Jerusalem zu tun?" Am Ende brach er mit der Großkirche und schloss sich den Montanisten an.', enText: 'Coined the Latin words the church has used for God ever since – "trinitas", "persona", "substantia". Asked mockingly: "what has Athens to do with Jerusalem?" In the end he broke with the mainstream church and joined the Montanists.' },
  { id: 'cyprian', de: 'Cyprian von Karthago', en: 'Cyprian of Carthage', parent: 'tertullian', faith: true, born: 210, epoch: 'kirchenvater', refs: [],
    city: 'Karthago', cityEn: 'Carthage', lat: 36.85, lon: 10.32, tradition: 'west', years: '≈ 210–258',
    deText: 'Bischof in einer Verfolgung, und danach vor der härteren Frage: Was tun mit denen, die eingeknickt sind? Er setzte Wiederaufnahme nach Buße durch, gegen die Strengen. „Wer die Kirche nicht zur Mutter hat, hat Gott nicht zum Vater." Starb selbst als Märtyrer.', enText: 'A bishop through persecution, and afterwards facing the harder question: what to do with those who gave way? He carried readmission after penance against the rigorists. "No one can have God as father who does not have the church as mother." He died a martyr himself.' },
  { id: 'ephrem', de: 'Ephräm der Syrer', en: 'Ephrem the Syrian', parent: 'athanasius', faith: true, born: 306, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Schrieb Theologie in Hymnen statt in Abhandlungen – hunderte davon, auf Syrisch, gesungen von Frauenchören, die er selbst ausbildete. Die syrische Kirche nennt ihn „die Harfe des Geistes"; im Westen kannte man ihn lange kaum.', enText: 'Wrote theology as hymns rather than treatises – hundreds of them, in Syriac, sung by women’s choirs he trained himself. The Syriac church calls him "the harp of the Spirit"; in the West he was long barely known.' },
  { id: 'basilius', de: 'Basilius der Große', en: 'Basil the Great', parent: 'athanasius', faith: true, born: 330, epoch: 'kirchenvater', refs: [],
    city: 'Caesarea (Kappadokien)', cityEn: 'Caesarea (Cappadocia)', lat: 38.73, lon: 35.48, tradition: 'east', years: '≈ 330–379',
    deText: 'Schrieb eine Mönchsregel, die den Osten bis heute prägt, und baute vor Caesarea eine ganze Vorstadt aus Krankenhaus, Herberge und Armenküche – die „Basiliade", eine der ersten Einrichtungen dieser Art überhaupt. Zugleich der Organisator der drei Kappadokier.', enText: 'Wrote a monastic rule that still shapes the East, and built outside Caesarea a whole suburb of hospital, hostel and soup kitchen – the "Basiliad", one of the first institutions of its kind anywhere. He was also the organiser among the three Cappadocians.' },
  { id: 'gregor_naz', de: 'Gregor von Nazianz', en: 'Gregory of Nazianzus', parent: 'basilius', faith: true, born: 329, epoch: 'kirchenvater', refs: [],
    city: 'Nazianz', cityEn: 'Nazianzus', lat: 38.4, lon: 34.5, tradition: 'east', years: '≈ 329–390',
    deText: 'Kam in eine Stadt, in der nur eine einzige Hauskapelle rechtgläubig war, und predigte fünf Reden über die Trinität, die ihm den Beinamen „der Theologe" eintrugen. Leitete kurz das Konzil von 381 – und trat zurück, weil ihm der Streit zuwider war.', enText: 'Came to a city where a single house chapel held to Nicene faith, and preached five orations on the Trinity that earned him the title "the Theologian". Briefly presided over the council of 381 – and resigned, because the infighting disgusted him.' },
  { id: 'chrysostomus', de: 'Johannes Chrysostomus', en: 'John Chrysostom', parent: 'basilius', faith: true, born: 349, epoch: 'kirchenvater', refs: [],
    city: 'Antiochia / Konstantinopel', cityEn: 'Antioch / Constantinople', lat: 41.01, lon: 28.98, tradition: 'east', years: '≈ 349–407',
    deText: 'Predigte in Antiochia und Konstantinopel Vers für Vers durch ganze Bücher und rechnete dabei so unverblümt mit dem Reichtum der Hauptstadt ab, dass die Kaiserin ihn zweimal verbannte. Er starb auf dem Weg ins Exil. Seine Predigten gegen die Juden haben später schweren Schaden angerichtet.', enText: 'Preached verse by verse through whole books in Antioch and Constantinople, and attacked the capital’s wealth so bluntly that the empress exiled him twice. He died on the road into exile. His sermons against the Jews did grave damage later on.' },
  { id: 'ambrosius', de: 'Ambrosius von Mailand', en: 'Ambrose of Milan', parent: 'athanasius', faith: true, born: 340, epoch: 'kirchenvater', refs: [],
    city: 'Mailand', cityEn: 'Milan', lat: 45.46, lon: 9.19, tradition: 'west', years: '≈ 340–397',
    deText: 'Wurde als ungetaufter Statthalter zum Bischof ausgerufen und lernte Theologie im Amt. Er stellte sich einem Kaiser in den Weg und verlangte öffentliche Buße nach einem Massaker – der erste Fall, in dem ein Bischof so etwas durchsetzte. Augustinus hörte ihn predigen.', enText: 'Was acclaimed bishop while still an unbaptised provincial governor, and learned theology on the job. He stood in an emperor’s way and demanded public penance after a massacre – the first time a bishop made that stick. Augustine heard him preach.' },
  { id: 'perpetua', de: 'Perpetua von Karthago', en: 'Perpetua of Carthage', parent: 'tertullian', faith: true, born: 182, epoch: 'kirchenvater', refs: [],
    city: 'Karthago', cityEn: 'Carthage', lat: 36.85, lon: 10.32, tradition: 'west', years: '≈ 182–203',
    deText: 'Junge Mutter, im Gefängnis hingerichtet. Ihr Tagebuch aus der Haft ist einer der ältesten erhaltenen Texte einer Christin überhaupt – sie schreibt über ihren Vater, ihr Kind und ihre Träume, bis eine fremde Hand den Schluss ergänzt.', enText: 'A young mother, executed in the arena. Her prison diary is one of the oldest surviving texts by a Christian woman at all – she writes about her father, her child and her dreams, until another hand adds the ending.' },
  { id: 'makrina', de: 'Makrina die Jüngere', en: 'Macrina the Younger', parent: 'athanasius', faith: true, born: 327, epoch: 'kirchenvater', refs: [],
    city: 'Annisa (Pontus)', lat: 40.59, lon: 36.95, tradition: 'east', years: '≈ 327–379',
    deText: 'Ältere Schwester von Basilius und Gregor von Nyssa und die Lehrerin beider: Sie verwandelte das Familiengut am Iris in eine Gemeinschaft, in der Herrinnen und Sklavinnen gemeinsam lebten. Was wir über sie wissen, schrieb Gregor auf – aus seiner Sicht, nicht ihrer.', enText: 'Elder sister of Basil and Gregory of Nyssa, and teacher of both: she turned the family estate on the Iris into a community where mistresses and slaves lived as equals. What we know of her, Gregory wrote down – from his vantage point, not hers.' },
  { id: 'gregor_nyssa', de: 'Gregor von Nyssa', en: 'Gregory of Nyssa', parent: 'basilius', faith: true, born: 335, epoch: 'kirchenvater', refs: [],
    city: 'Nyssa (Kappadokien)', cityEn: 'Nyssa (Cappadocia)', lat: 38.63, lon: 34.3, tradition: 'east', years: '≈ 335–395',
    deText: 'Der spekulativste der drei Kappadokier: Für ihn ist Gott unendlich, also endet auch das Erkennen nie – der Himmel ist kein Stillstand, sondern ein Weitergehen ohne Ende. Er schrieb einen der frühesten Texte gegen die Sklaverei überhaupt.', enText: 'The most speculative of the three Cappadocians: for him God is infinite, so knowing God never ends – heaven is not standing still but going further without end. He wrote one of the earliest texts against slavery as such.' },
  { id: 'johannes_dam', de: 'Johannes von Damaskus', en: 'John of Damascus', parent: 'gregor_naz', faith: true, born: 675, epoch: 'kirchenvater', refs: [],
    city: 'Mar Saba', lat: 31.705, lon: 35.331, tradition: 'east', years: '≈ 675–749',
    deText: 'Der letzte der griechischen Väter, und er schrieb außerhalb des Reiches: unter muslimischer Herrschaft, wo der Kaiser ihn nicht erreichte. Von dort verteidigte er die Bilder gegen das Bilderverbot aus Konstantinopel – mit dem Argument, Gott selbst sei sichtbar geworden.', enText: 'The last of the Greek fathers, and he wrote outside the empire: under Muslim rule, where the emperor could not reach him. From there he defended images against Constantinople’s ban – on the argument that God himself had become visible.' },
  { id: 'kyrill', de: 'Kyrill von Alexandria', en: 'Cyril of Alexandria', parent: 'athanasius', faith: true, born: 376, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Setzte in Ephesus 431 gegen Nestorius durch, dass Maria „Gottesgebärerin" heißt – theologisch eine Aussage über Christus, nicht über sie. Seine Mittel dabei waren hart und teils gekauft; über seine Rolle im Klima, in dem die Philosophin Hypatia ermordet wurde, streiten Historiker bis heute.', enText: 'At Ephesus in 431 he carried the point against Nestorius that Mary is "God-bearer" – theologically a statement about Christ, not about her. His methods were harsh and partly bought; historians still argue over his role in the climate in which the philosopher Hypatia was murdered.' },
  ...
  { id: 'gregor_gross', de: 'Gregor der Große', en: 'Gregory the Great', parent: 'benedikt', faith: true, born: 540, epoch: 'mittelalter', refs: [],
    city: 'Rom', cityEn: 'Rome', lat: 41.89, lon: 12.49, tradition: 'west', years: '≈ 540–604',
    deText: 'Übernahm Rom, als die Stadt von Pest und Krieg ausgeblutet war, und verwaltete faktisch, was das Reich nicht mehr konnte. Nannte sich „Knecht der Knechte Gottes" – der Titel gilt bis heute. Schickte Mönche nach England, statt auf Bekehrung zu warten.', enText: 'Took over Rome when the city had been bled by plague and war, and in practice administered what the empire no longer could. Called himself "servant of the servants of God" – the title stands to this day. Sent monks to England rather than waiting for conversion.' },
