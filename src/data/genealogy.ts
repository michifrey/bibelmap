...
export const GENEALOGY: Person[] = [
  ...
  { id: 'justin', de: 'Justin der Märtyrer', en: 'Justin Martyr', parent: 'polykarp', line: true, faith: true, born: 100, epoch: 'kirchenvater', refs: [],
    city: 'Rom', lat: 41.89, lon: 12.49, tradition: 'east', years: '≈ 100–165',
  ...
  { id: 'hieronymus', de: 'Hieronymus', en: 'Jerome', parent: 'athanasius', faith: true, born: 347, epoch: 'kirchenvater', refs: [],
    ...
    deText: 'Zog nach Betlehem und übersetzte die Bibel aus dem Hebräischen statt aus der griechischen Fassung – umstritten damals, maßgebend für tausend Jahre. Streitsüchtig bis zur Bosheit; einen großen Teil der Arbeit trug ein Kreis gelehrter Frauen um Paula mit.', enText: 'Moved to Bethlehem and translated the Bible from Hebrew rather than the Greek version – controversial then, authoritative for a thousand years. Quarrelsome to the point of malice; much of the work was carried with him by a circle of learned women around Paula.' },
  ...
  { id: 'perpetua', de: 'Perpetua von Karthago', en: 'Perpetua of Carthage', parent: 'tertullian', faith: true, born: 182, epoch: 'kirchenvater', refs: [],
    city: 'Karthago', lat: 36.85, lon: 10.32, tradition: 'west', years: '≈ 182–203',
  ...
  { id: 'gregor_nyssa', de: 'Gregor von Nyssa', en: 'Gregory of Nyssa', parent: 'basilius', faith: true, born: 335, epoch: 'kirchenvater', refs: [],
    city: 'Nyssa (Kappadokien)', lat: 38.63, lon: 34.3, tradition: 'east', years: '≈ 335–395',
  ...
  { id: 'johannes_dam', de: 'Johannes von Damaskus', en: 'John of Damascus', parent: 'gregor_naz', faith: true, born: 675, epoch: 'kirchenvater', refs: [],
    city: 'Mar Saba bei Jerusalem', lat: 31.705, lon: 35.331, tradition: 'east', years: '≈ 675–749',
