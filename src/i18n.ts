...
const STRINGS: Dict = {
  ...
  quiz: { de: 'Ortskenntnis', en: 'Place quiz' },
  quizSub: { de: 'Wo liegt Kapernaum? Auf die Karte tippen, Punkte sammeln.', en: 'Where is Capernaum? Tap the map, collect points.' },
  quizHint: {
    de: 'Acht Orte, acht Versuche: Der Name steht oben, der Klick auf die Karte ist die Antwort. Je näher, desto mehr Punkte – die Karte trägt keine Beschriftung, sonst wäre es zu leicht.',
    en: 'Eight places, eight guesses: the name is at the top, your click on the map is the answer. The closer, the more points – the map carries no labels, or it would be too easy.',
  },
