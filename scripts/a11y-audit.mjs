...
const ANSICHTEN = ['', '#karte', '#reise=exodus,2', '#mission=modern', '#quiz', '#lesen=Acts,13', '#stammbaum', '#graph', '#kirche', '#vergleich', '#hoeren', '#weg=a15257a,a112427', '#gelaende', '#heilsgeschichte', '#feste=pessach', '#register', '#israel=okt2023', '#jesus=passion', '#jesus=mensch,petrus', '#kirche=zeit,thesen', '#unterstuetzen', '#nachweise', '#fahrplan', '#impressum'];
